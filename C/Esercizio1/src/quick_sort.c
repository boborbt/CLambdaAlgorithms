...
void array_block_swap_to_end(void** array, int start, int end, int len) {
  int b1_start = start;
...
void dump_status(void** array, int start, int end, int i, int j, int p) {
#ifdef __DEBUG__
...
int partition(void** array, int start, int end, QSCompareFun compare) {
...
void quick_sort_standard(void** array, int start, int end, QSCompareFun compare) {
...
void quick_sort_3_way(void** array, int start, int end, QSCompareFun compare) {
  if(end - start < 1) return;
